...
class Author2ArtifactExtraction(Extraction):
    def __init__(self, dbm, conf, resdir):
        Extraction.__init__(self, dbm, conf, resdir)

        self.file_name = "author2{artifact}.list"
    ...
    def _reduce_result(self, result):
        return [(dev_name, art) for dev_id, dev_name, art in result]


class Author2FileExtraction(Extraction):
    def __init__(self, dbm, conf, resdir):
        Extraction.__init__(self, dbm, conf, resdir)

        self.file_name = "author2file.list"
    ...
    def _reduce_result(self, result):
        return [(dev_name, filename) for dev_id, dev_name, filename in result]


class Commit2ArtifactExtraction(Extraction):
    def __init__(self, dbm, conf, resdir):
        Extraction.__init__(self, dbm, conf, resdir)

        self.file_name = "commit2{artifact}.list"
...
class Commit2FileExtraction(Extraction):
    def __init__(self, dbm, conf, resdir):
        Extraction.__init__(self, dbm, conf, resdir)

        self.file_name = "commit2file.list"
...
class Thread2AuthorExtraction(Extraction):
    def __init__(self, dbm, conf, resdir):
        Extraction.__init__(self, dbm, conf, resdir)

        self.file_name = "thread2authors.list"
